...
4. **Registry package submissions** — Contributors to **agents-repo/registry**
   ...
   a pull request from the fork to upstream `main`. This exception does **not**
   relax issue-first requirements for webapp, cli, registry-proxy, or
   non-package registry work (specs, tooling, platform changes).
