...
3. Push the branch and open a draft pull request targeting `main` before
   ...
   format in `CONTRIBUTING.md` **Workflow exceptions** when applicable. GitHub
...
This repo uses **manual** Copilot and Cursor instruction files (no sync
scripts). When changing agent guidance, update **both** in the same pull
request:
